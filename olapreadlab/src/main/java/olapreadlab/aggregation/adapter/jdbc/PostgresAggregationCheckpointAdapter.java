...
@Repository
class PostgresAggregationCheckpointAdapter implements AggregationCheckpointPort {
	...
	PostgresAggregationCheckpointAdapter(
	...
	public Optional<Instant> findCoveredUntil(
			String model, String view, AggregationPipeline pipeline) {
