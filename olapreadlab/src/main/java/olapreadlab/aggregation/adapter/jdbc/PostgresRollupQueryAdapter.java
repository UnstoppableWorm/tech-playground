...
@Repository
class PostgresRollupQueryAdapter implements RollupQueryPort {
	...
	public List<ResultRow> queryRollup(
		...
		return JdbcQueryExecutor.queryRollup(postgres, compiled);
	}
}
